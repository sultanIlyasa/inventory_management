...
Route::get('/annual-inventory/fiscal-years', [AnnualInventoryController::class, 'fiscalYears']);
Route::post('/annual-inventory/fiscal-years', [AnnualInventoryController::class, 'saveFiscalYear']);
